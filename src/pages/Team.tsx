...
const teamMembers: TeamMember[] = [
  {
    ...
    description:
      "An IIM Grad who loves everything but management! Meet Vartika – Our lead on Programming and Content. ‘I am not up for sale, so don’t publish my bio’, she insists. So we dare upset our head of Programming and continue to write about her! Period.",
  ...
  },
  {
    ...
    description:
      "His soft-skills, networking abilities & media relationships could have made him India’s leading Public Relations executive, but Roheet had different plans.In his career spanning 18 years, Roheet has led teams at the Country’s best experiential & media organisation such as Wizcraft International, Entertainment Network India (part of Times of India), Times Television and Hindustan Times. His heavily decorated chest wears medals of Iconic IPRs like Channel V Awards, India International Film Festival, Film Fare Awards, Femina Miss India, HT Leadership Summit, JK Racing Championship, India Fashion Week, to name a few.",
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="pt-36 pb-24 text-center relative">
        ...
        <div className="max-w-4xl mx-auto px-4">
          ...
          >
            Our diverse team of creative professionals brings together years of
            experience, innovative thinking, and a passion for delivering
              ...
              <motion.div
                ...
                className={
                  index === teamMembers.length - 1
                    ? "p-px bg-gradient-to-br from-pink-500 to-cyan-400 rounded-3xl"
                    : ""
                }
              >
                <div className="h-full bg-slate-900 rounded-3xl p-6 md:p-8">
                  <div className="flex flex-col sm:flex-row items-start gap-6">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-pink-500 font-semibold text-md mt-1">
                        {member.role}
                      </p>
                    </div>
                  </div>
